 ...
 * for the next job each cycle - any process that serves GET <url> -> 200 {service?, arg, budgetSol?,
 * note?} | 204 can drive it. A quiet market posts nothing - no event, no WANT, no spend.
 */
