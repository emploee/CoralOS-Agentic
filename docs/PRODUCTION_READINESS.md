...
| Admin/support | No admin or operator UI ships in this kit. | Auth/RBAC required before hosting any future admin surface. |
...
- Define SLOs for proxy, feed, and settlement flows.
...
- Add auth, authorization, and audit logging for admin/feed operations.
...
3. No hosted auth/RBAC protects feed endpoints.
